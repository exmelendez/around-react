...
function Card(props) {
  ...
  return (
    <li className="photos__item">
      <button className={`photos__delete-btn ${isOwn && 'photos__delete-btn_visible'}`} aria-label="Delete card"></button>
      ...
      <div className="photos__item-info">
        ...
        <div className="photos__likes-container">
          <button className={`photos__love-btn ${isLiked && 'photos__love-btn_liked'}`} aria-label="Love"></button>
